...
/* EUROPE */
{
    "id": "europe-quartiers",
    "priorityId": "europe",
    "title": " l’Europe se doit se voir et se vivre dans les quartiers",
    "impact": "L'Europe finance votre quotidien",
    "tag": "Europe",
    "constat": " À Strasbourg, les habitants veulent que le statut européen profite concrètement àleur quotidien. L’innovation ne doit pas rester l’apanage de quelques-uns : elle doit irriguer tous les quartiers, toutes les générations et toutes les initiatives citoyennes. ",
    "proposition": "Marché de Noël local et transparent « Marché des Quartiers », Route européenne des traditions « Strasbourg Connecte », Soutien aux start-up à impact « Europol Innovation », Projets européens concrets dans les quartiers  .",
