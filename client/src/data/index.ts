...
/* LOGEMENT */
{
    ...
    "tag": "Logement",
    "constat": "Les habitants dénoncent : l’opacité des attributions de logements sociaux,la dégradation de certains logements (humidité, chauffage défaillant, insalubrité),l’impossibilité d’alerter efficacement quand un logement devient indigne, un sentimentd’abandon face à certains bailleurs.",
    "proposition": "Transparence et contrôle du logement social, Contrôle local de l’habitat,  .",
    ...
    "isKeyMeasure": true},
{
    ...
    "tag": "Services publics",
    "constat": "Pour beaucoup de Strasbourgeoises et Strasbourgeois, l’administration estdevenue un mur : démarches incompréhensibles, guichets éloignés ou saturés, dématérialisation brutale sans accompagnement. Cette distance crée une solitudeadministrative (anxiété), particulièrement chez les seniors, les familles précaires et les personnes peu à l’aise avec le numérique.",
    "proposition": "Bus-Mairie itinérant « La Ville vient à vous », Stands municipaux sur les marchés « Parlons Services Publics », Ambassadeurs de quartier bénévoles « Voisins-Relais », Ateliers de lutte contre l’illectronisme « Pas à Pas Numérique »  .",
    ...
    "isKeyMeasure": false},
{
    ...
    "priorityId": "inclusion_droits",
    "title": "Ville inclusive et accès aux droits t",
    "impact": "Renforcer la cohésion sociale",
    "tag": "Inclusion",
    "constat": "À Strasbourg, ce sont les habitants eux-mêmes qui racontent la difficulté de traverserl’urgence sociale au quotidien. Ils témoignent de parcours chaotiques : hébergementsdiscontinus, accès limité pour les personnes à mobilité réduite, dispositifs peu coordonnés et suivi insuffisant. Charte de transparence hôtelière pour l’urgence sociale. Espaces de dignité et projets innovants.  ",
    "proposition": "Accessibilité universelle renforcée, Soutien prioritaire aux femmes victimes de violences et aux personnesen fragilité Réorganisation de l’hébergement d’urgence,Innovation numérique et participation citoyenne . ",
...
/* PRÉVENTION */
{
    ...
    "tag": "Prévention",
    "constat": "À Strasbourg, familles, éducateurs et bénévoles alertent depuis trop longtemps : lessignaux faibles sont souvent ignorés, et les familles, qui sont pourtant centrales, ne sont pas suffisamment associées aux dispositifs de prévention.",
    "proposition": "Pôle municipal dédié à la prévention et à la vigilance éducative, Coordination renforcée entre écoles, associations, services sociaux et familles, Formation systématique et continue des acteurs locaux, Dialogue interconvictionnel et interculturel, Espace Familles de Prévention, Programme « Passerelles numériques », Approche positive et non stigmatisante.",
...
/* FINANCES */
{
    ...
    "proposition": "Audit indépendant annuel, Suppression des dépenses inefficaces, Valorisation du patrimoine municipal, Aucune hausse d’impôts locaux, Plateforme citoyenne de transparence budgétaire, Budget participatif renforcé et innovantc  ",
...
/* SÉCURITÉ */
{
    "id": "securite-police",
    "priorityId": "securite",
    "title": ": Vivre en sécurité,sans être stigmatisé",
    "impact": "Rassurer et dissuader",
    "tag": "Sécurité",
    "constat": "À Strasbourg, les habitants réclament plus de présence humaine et des réponsesadaptées aux réalités locales, sans tomber dans la répression systématique. Ils veulent se sentir protégés, avec moins de tensions et des solutions de prévention efficaces.",
    "proposition": "Patrouilles mixtes et de proximité, Médiateurs de soirée, Éclairage intelligent et sécurisation urbaine, Urbanisme de prévention, Pacte local de tranquillité, Plateforme citoyenne de signalement et de suivi.",
